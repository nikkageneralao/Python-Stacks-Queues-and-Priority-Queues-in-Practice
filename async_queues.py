...
# // defining a new data type representing a job that'll put in the queue, as well as an asynchronous worker performing the job
import sys
from typing import NamedTuple

# // Adding the .__lt__() special method to Job class
...
# // adding fetching content and parsing HTML links
